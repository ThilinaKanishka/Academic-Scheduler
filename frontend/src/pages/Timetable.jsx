...
const TimetableGenerator = () => {
  ...
  const handleAddEntry = () => {
    if (selectedModule && selectedClassroom && selectedFaculty) {
      ...
      alert("Please select a module, classroom, and faculty.");
    }
  };
  ...
  const handleGenerateTimetable = async () => {
    ...
    if (entries.length < 4) {
      alert("Please add at least 4 entries to generate a timetable.");
      return;
    }
  
    console.log("Sending timetable title:", timetableTitle); // Debugging log
