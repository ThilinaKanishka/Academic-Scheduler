...
exports.createClassroom = async (req, res) => {
  try {
    const { roomNumber, capacity, classroomType, hasProjector } = req.body;
    const classroom = new Classroom({ roomNumber, capacity, classroomType, hasProjector });
...
exports.updateClassroom = async (req, res) => {
  try {
    ...
    const updatedClassroom = await Classroom.findByIdAndUpdate(
      id,
      { roomNumber, capacity, classroomType, hasProjector },
      { new: true }
    );
